...
namespace SIARH.DAL
{
    ...
    public partial class ReqSolicitudPrimaria
    {
        ...
        public Nullable<int> idOrganizacionTurno { get; set; }
        public Nullable<int> idOrgCompartida { get; set; }
        public Nullable<int> idJornada { get; set; }
        public Nullable<bool> cargaMateria { get; set; }
        ...
        public virtual RefEstadoSolicitud RefEstadoSolicitud1 { get; set; }
