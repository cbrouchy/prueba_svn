...
namespace SIARH.DAL
{
    ...
    public partial class RefTipoEspacioCurricular
    {
        ...
        {
            this.EspacioCurricular = new HashSet<EspacioCurricular>();
        }
    
        public int idTipoEspacioCurricular { get; set; }
        public string tipoEspacioCurricular { get; set; }
        public bool estaActivo { get; set; }
        public Nullable<System.DateTime> fechaCaducidad { get; set; }
    
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<EspacioCurricular> EspacioCurricular { get; set; }
    }
}
